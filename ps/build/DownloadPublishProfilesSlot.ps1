...
{
    Get-AzureRmWebAppSlotPublishingProfile -ResourceGroupName $resourceGroup -Name $application -Slot $slotName -Format WebDeploy -OutputFile "$application.publishsettings"
}
